...
class Throttle {
	...
	public const endpoints = array(
		...
		'/user/post-discussion' => 2,
		'/user/get-discussion' => 20,
		'/user/lock-discussion' => 3,
		'/user/delete-discussion' => 3,
		'/user/edit-discussion' => 5,
		'/user/post-comment' => 3,
		...
		'/user/save-pii' => 5,
		'/user/get-shufti-token' => 3,
		'/user/validate-shufti-signature' => 20,
		'/user/save-shufti-ref' => 3,
		'/user/get-suspension-status' => 12,
		'/user/request-reactivation' => 3,
