...
include_once('classes/CasperSigVerify.php');
include_once('classes/permissions.php');
include_once('classes/pagelock.php');
include_once('classes/suspensions.php');
...
function authenticate_session($required_clearance = 1) {
	...
	switch ($session_role) {
		case 'test-user':   $clearance = 1; break;
